                ...
                {app.storeLinks.map((store, idx) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span>{(store.platform !== 'github' && store.platform !== 'web') ? `Download for ${store.platform.charAt(0).toUpperCase() + store.platform.slice(1)}` : `Go to ${store.platform.charAt(0).toUpperCase() + store.platform.slice(1)}`}</span>
                    </div>
                    <Download size={20} />
                  </a>
                ))}
